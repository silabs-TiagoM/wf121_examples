...
enum wifi_msg_idx
{
	...
	wifi_cmd_tcpip_start_tcp_server_idx =33,
	wifi_cmd_tcpip_tcp_connect_idx =34,
	wifi_cmd_tcpip_start_udp_server_idx =35,
	wifi_cmd_tcpip_udp_connect_idx =36,
	wifi_cmd_tcpip_configure_idx =37,
	wifi_cmd_tcpip_dns_configure_idx =38,
	wifi_cmd_tcpip_dns_gethostbyname_idx =39,
	wifi_cmd_tcpip_udp_bind_idx =40,
	wifi_cmd_tcpip_dhcp_set_hostname_idx =41,
	wifi_cmd_tcpip_dhcp_enable_routing_idx =42,
	wifi_cmd_tcpip_mdns_set_hostname_idx =43,
	wifi_cmd_tcpip_mdns_start_idx =44,
	wifi_cmd_tcpip_mdns_stop_idx =45,
	wifi_cmd_tcpip_dnssd_add_service_idx =46,
	wifi_cmd_tcpip_dnssd_add_service_instance_idx =47,
	wifi_cmd_tcpip_dnssd_add_service_attribute_idx =48,
	wifi_cmd_tcpip_dnssd_remove_service_idx =49,
	wifi_cmd_tcpip_dnssd_start_service_idx =50,
	wifi_cmd_tcpip_dnssd_stop_service_idx =51,
	wifi_cmd_endpoint_send_idx =52,
	wifi_cmd_endpoint_set_streaming_idx =53,
	wifi_cmd_endpoint_set_active_idx =54,
	wifi_cmd_endpoint_set_streaming_destination_idx =55,
	wifi_cmd_endpoint_close_idx =56,
	wifi_cmd_endpoint_set_transmit_size_idx =57,
	wifi_cmd_endpoint_disable_idx =58,
	wifi_cmd_hardware_set_soft_timer_idx =59,
	wifi_cmd_hardware_external_interrupt_config_idx =60,
	wifi_cmd_hardware_change_notification_config_idx =61,
	wifi_cmd_hardware_change_notification_pullup_idx =62,
	wifi_cmd_hardware_io_port_config_direction_idx =63,
	wifi_cmd_hardware_io_port_config_open_drain_idx =64,
	wifi_cmd_hardware_io_port_write_idx =65,
	wifi_cmd_hardware_io_port_read_idx =66,
	wifi_cmd_hardware_output_compare_idx =67,
	wifi_cmd_hardware_adc_read_idx =68,
	wifi_cmd_hardware_rtc_init_idx =69,
	wifi_cmd_hardware_rtc_set_time_idx =70,
	wifi_cmd_hardware_rtc_get_time_idx =71,
	wifi_cmd_hardware_rtc_set_alarm_idx =72,
	wifi_cmd_hardware_uart_conf_set_idx =73,
	wifi_cmd_hardware_uart_conf_get_idx =74,
	wifi_cmd_flash_ps_defrag_idx =75,
	wifi_cmd_flash_ps_dump_idx =76,
	wifi_cmd_flash_ps_erase_all_idx =77,
	wifi_cmd_flash_ps_save_idx =78,
	wifi_cmd_flash_ps_load_idx =79,
	wifi_cmd_flash_ps_erase_idx =80,
	wifi_cmd_i2c_start_read_idx =81,
	wifi_cmd_i2c_start_write_idx =82,
	wifi_cmd_i2c_stop_idx =83,
	wifi_cmd_https_enable_idx =84,
	wifi_cmd_https_add_path_idx =85,
	wifi_cmd_https_api_response_idx =86,
	wifi_cmd_https_api_response_finish_idx =87,
	wifi_cmd_ethernet_set_dataroute_idx =88,
	wifi_cmd_ethernet_close_idx =89,
	wifi_cmd_ethernet_connected_idx =90,
	wifi_cmd_sdhc_fopen_idx =91,
	wifi_cmd_sdhc_fclose_idx =92,
	wifi_cmd_sdhc_fdir_idx =93,
	wifi_cmd_sdhc_fread_idx =94,
	wifi_cmd_sdhc_fwrite_idx =95,
	wifi_cmd_sdhc_fdelete_idx =96,
	wifi_cmd_sdhc_fmkdir_idx =97,
	wifi_cmd_sdhc_fchdir_idx =98,
	wifi_cmd_sdhc_frename_idx =99,
	wifi_cmd_sdhc_fchmode_idx =100,
	wifi_cmd_util_atoi_idx =101,
	wifi_cmd_util_itoa_idx =102,
	wifi_rsp_dfu_reset_idx =103,
	wifi_rsp_dfu_flash_set_address_idx =104,
	wifi_rsp_dfu_flash_upload_idx =105,
	wifi_rsp_dfu_flash_upload_finish_idx =106,
	wifi_rsp_system_sync_idx =107,
	wifi_rsp_system_reset_idx =108,
	wifi_rsp_system_hello_idx =109,
	wifi_rsp_system_set_max_power_saving_state_idx =110,
	wifi_rsp_config_get_mac_idx =111,
	wifi_rsp_config_set_mac_idx =112,
	wifi_rsp_sme_wifi_on_idx =113,
	wifi_rsp_sme_wifi_off_idx =114,
	wifi_rsp_sme_power_on_idx =115,
	wifi_rsp_sme_start_scan_idx =116,
	wifi_rsp_sme_stop_scan_idx =117,
	wifi_rsp_sme_set_password_idx =118,
	wifi_rsp_sme_connect_bssid_idx =119,
	wifi_rsp_sme_connect_ssid_idx =120,
	wifi_rsp_sme_disconnect_idx =121,
	wifi_rsp_sme_set_scan_channels_idx =122,
	wifi_rsp_sme_set_operating_mode_idx =123,
	wifi_rsp_sme_start_ap_mode_idx =124,
	wifi_rsp_sme_stop_ap_mode_idx =125,
	wifi_rsp_sme_scan_results_sort_rssi_idx =126,
	wifi_rsp_sme_ap_client_disconnect_idx =127,
	wifi_rsp_sme_set_ap_password_idx =128,
	wifi_rsp_sme_set_ap_max_clients_idx =129,
	wifi_rsp_sme_start_wps_idx =130,
	wifi_rsp_sme_stop_wps_idx =131,
	wifi_rsp_sme_get_signal_quality_idx =132,
	wifi_rsp_sme_start_ssid_scan_idx =133,
	wifi_rsp_sme_set_ap_hidden_idx =134,
	wifi_rsp_sme_set_11n_mode_idx =135,
	wifi_rsp_tcpip_start_tcp_server_idx =136,
	wifi_rsp_tcpip_tcp_connect_idx =137,
	wifi_rsp_tcpip_start_udp_server_idx =138,
	wifi_rsp_tcpip_udp_connect_idx =139,
	wifi_rsp_tcpip_configure_idx =140,
	wifi_rsp_tcpip_dns_configure_idx =141,
	wifi_rsp_tcpip_dns_gethostbyname_idx =142,
	wifi_rsp_tcpip_udp_bind_idx =143,
	wifi_rsp_tcpip_dhcp_set_hostname_idx =144,
	wifi_rsp_tcpip_dhcp_enable_routing_idx =145,
	wifi_rsp_tcpip_mdns_set_hostname_idx =146,
	wifi_rsp_tcpip_mdns_start_idx =147,
	wifi_rsp_tcpip_mdns_stop_idx =148,
	wifi_rsp_tcpip_dnssd_add_service_idx =149,
	wifi_rsp_tcpip_dnssd_add_service_instance_idx =150,
	wifi_rsp_tcpip_dnssd_add_service_attribute_idx =151,
	wifi_rsp_tcpip_dnssd_remove_service_idx =152,
	wifi_rsp_tcpip_dnssd_start_service_idx =153,
	wifi_rsp_tcpip_dnssd_stop_service_idx =154,
	wifi_rsp_endpoint_send_idx =155,
	wifi_rsp_endpoint_set_streaming_idx =156,
	wifi_rsp_endpoint_set_active_idx =157,
	wifi_rsp_endpoint_set_streaming_destination_idx =158,
	wifi_rsp_endpoint_close_idx =159,
	wifi_rsp_endpoint_set_transmit_size_idx =160,
	wifi_rsp_endpoint_disable_idx =161,
	wifi_rsp_hardware_set_soft_timer_idx =162,
	wifi_rsp_hardware_external_interrupt_config_idx =163,
	wifi_rsp_hardware_change_notification_config_idx =164,
	wifi_rsp_hardware_change_notification_pullup_idx =165,
	wifi_rsp_hardware_io_port_config_direction_idx =166,
	wifi_rsp_hardware_io_port_config_open_drain_idx =167,
	wifi_rsp_hardware_io_port_write_idx =168,
	wifi_rsp_hardware_io_port_read_idx =169,
	wifi_rsp_hardware_output_compare_idx =170,
	wifi_rsp_hardware_adc_read_idx =171,
	wifi_rsp_hardware_rtc_init_idx =172,
	wifi_rsp_hardware_rtc_set_time_idx =173,
	wifi_rsp_hardware_rtc_get_time_idx =174,
	wifi_rsp_hardware_rtc_set_alarm_idx =175,
	wifi_rsp_hardware_uart_conf_set_idx =176,
	wifi_rsp_hardware_uart_conf_get_idx =177,
	wifi_rsp_flash_ps_defrag_idx =178,
	wifi_rsp_flash_ps_dump_idx =179,
	wifi_rsp_flash_ps_erase_all_idx =180,
	wifi_rsp_flash_ps_save_idx =181,
	wifi_rsp_flash_ps_load_idx =182,
	wifi_rsp_flash_ps_erase_idx =183,
	wifi_rsp_i2c_start_read_idx =184,
	wifi_rsp_i2c_start_write_idx =185,
	wifi_rsp_i2c_stop_idx =186,
	wifi_rsp_https_enable_idx =187,
	wifi_rsp_https_add_path_idx =188,
	wifi_rsp_https_api_response_idx =189,
	wifi_rsp_https_api_response_finish_idx =190,
	wifi_rsp_ethernet_set_dataroute_idx =191,
	wifi_rsp_ethernet_close_idx =192,
	wifi_rsp_ethernet_connected_idx =193,
	wifi_rsp_sdhc_fopen_idx =194,
	wifi_rsp_sdhc_fclose_idx =195,
	wifi_rsp_sdhc_fdir_idx =196,
	wifi_rsp_sdhc_fread_idx =197,
	wifi_rsp_sdhc_fwrite_idx =198,
	wifi_rsp_sdhc_fdelete_idx =199,
	wifi_rsp_sdhc_fmkdir_idx =200,
	wifi_rsp_sdhc_fchdir_idx =201,
	wifi_rsp_sdhc_frename_idx =202,
	wifi_rsp_sdhc_fchmode_idx =203,
	wifi_rsp_util_atoi_idx =204,
	wifi_rsp_util_itoa_idx =205,
	wifi_evt_dfu_boot_idx =206,
	wifi_evt_system_boot_idx =207,
	wifi_evt_system_state_idx =208,
	wifi_evt_system_sw_exception_idx =209,
	wifi_evt_system_power_saving_state_idx =210,
	wifi_evt_config_mac_address_idx =211,
	wifi_evt_sme_wifi_is_on_idx =212,
	wifi_evt_sme_wifi_is_off_idx =213,
	wifi_evt_sme_scan_result_idx =214,
	wifi_evt_sme_scan_result_drop_idx =215,
	wifi_evt_sme_scanned_idx =216,
	wifi_evt_sme_connected_idx =217,
	wifi_evt_sme_disconnected_idx =218,
	wifi_evt_sme_interface_status_idx =219,
	wifi_evt_sme_connect_failed_idx =220,
	wifi_evt_sme_connect_retry_idx =221,
	wifi_evt_sme_ap_mode_started_idx =222,
	wifi_evt_sme_ap_mode_stopped_idx =223,
	wifi_evt_sme_ap_mode_failed_idx =224,
	wifi_evt_sme_ap_client_joined_idx =225,
	wifi_evt_sme_ap_client_left_idx =226,
	wifi_evt_sme_scan_sort_result_idx =227,
	wifi_evt_sme_scan_sort_finished_idx =228,
	wifi_evt_sme_wps_stopped_idx =229,
	wifi_evt_sme_wps_completed_idx =230,
	wifi_evt_sme_wps_failed_idx =231,
	wifi_evt_sme_wps_credential_ssid_idx =232,
	wifi_evt_sme_wps_credential_password_idx =233,
	wifi_evt_sme_signal_quality_idx =234,
	wifi_evt_tcpip_configuration_idx =235,
	wifi_evt_tcpip_dns_configuration_idx =236,
	wifi_evt_tcpip_endpoint_status_idx =237,
	wifi_evt_tcpip_dns_gethostbyname_result_idx =238,
	wifi_evt_tcpip_udp_data_idx =239,
	wifi_evt_tcpip_mdns_started_idx =240,
	wifi_evt_tcpip_mdns_failed_idx =241,
	wifi_evt_tcpip_mdns_stopped_idx =242,
	wifi_evt_tcpip_dnssd_service_started_idx =243,
	wifi_evt_tcpip_dnssd_service_failed_idx =244,
	wifi_evt_tcpip_dnssd_service_stopped_idx =245,
	wifi_evt_endpoint_syntax_error_idx =246,
	wifi_evt_endpoint_data_idx =247,
	wifi_evt_endpoint_status_idx =248,
	wifi_evt_endpoint_closing_idx =249,
	wifi_evt_endpoint_error_idx =250,
	wifi_evt_hardware_soft_timer_idx =251,
	wifi_evt_hardware_change_notification_idx =252,
	wifi_evt_hardware_external_interrupt_idx =253,
	wifi_evt_hardware_rtc_alarm_idx =254,
	wifi_evt_hardware_uart_conf_idx =255,
	wifi_evt_flash_ps_key_idx =256,
	wifi_evt_flash_ps_key_changed_idx =257,
	wifi_evt_flash_low_voltage_idx =258,
	wifi_evt_https_on_req_idx =259,
	wifi_evt_https_button_idx =260,
	wifi_evt_https_api_request_idx =261,
	wifi_evt_https_api_request_header_idx =262,
	wifi_evt_https_api_request_data_idx =263,
	wifi_evt_https_api_request_finished_idx =264,
	wifi_evt_ethernet_link_status_idx =265,
	wifi_evt_sdhc_ready_idx =266,
	wifi_evt_sdhc_fdata_idx =267,
	wifi_evt_sdhc_ffile_idx =268,
	wifi_evt_sdhc_fpwd_idx =269
};
