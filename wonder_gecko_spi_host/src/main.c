 ...
 * the GPIOINT API. (pin parameter is not used)
 ****************************************************************************/
 ...
 * This function must be given as the parameter for BGLIB_INITIALIZE.
 *
 ...
 * send a 0 to the slave device and return the received byte.
 *
 ...
 * @param[in] rx  Pointer used to store the data
 * @return Returns -1 if there was nothind to read and 0 if it read the header successfully
 *****************************************************************************/
